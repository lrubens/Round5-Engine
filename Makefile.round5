...
srcdir    = reference/src
builddir  = reference/build
objdir    = reference/$(builddir)/.o
depdir    = reference/$(builddir)/.d
docdir    = reference/doc
...
compile: $(CC) -fPIC $(LDFLAGS) -c meths/*.c ossl/*.c $(LOADLIBS) $(LDLIBS)
