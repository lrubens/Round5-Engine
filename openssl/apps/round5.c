...
int round5_main(int argc, char **argv)
{
    ENGINE *e = NULL;
    BIO *out = NULL;
    RSA *rsa = NULL;
...
# endif
    ...
    prog = opt_init(argc, argv, round5_options);
...
# endif
    ...
    BIO_printf(bio_err, "writing Round5 key\n");
